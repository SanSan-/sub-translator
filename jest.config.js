...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^~forms(.*)$': '<rootDir>/app/src/components/forms$1',
    '^~hooks(.*)$': '<rootDir>/app/src/hooks$1',
    '^~model(.*)$': '<rootDir>/app/src/model$1',
    '^~const(.*)$': '<rootDir>/app/src/model/constants$1',
    '^~dictionaries(.*)$': '<rootDir>/app/src/model/dictionaries$1',
    '^~enums(.*)$': '<rootDir>/app/src/model/enums$1',
    '^~exceptions(.*)$': '<rootDir>/app/src/model/exceptions$1',
